...
function Generator(prop: {
    ...
    poison: string,
    muscles: string[],
    setPoison: (value: string) => void,
    setMuscles: (value: string[]) => void,
    goal: string,
    setGoal: (value: string) => void
formulate    : () => void
}) {
    const {poison, muscles, setPoison, setMuscles, goal, setGoal , formulate } = prop;
    const {ref} = prop;
    ...
    return (
        <SectionWrapper ref={ref} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
